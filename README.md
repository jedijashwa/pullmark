...
- **Click to inspect** — images, Mermaid diagrams, and block formulas open in a focused overlay with pan and zoom, so complex diagrams aren't stuck at reading-column width.
...
- **Recents** — recently opened files, folders, and pull requests live in **File → Open Recent**, a sidebar section, the Dock icon's menu, and Apple → Recent Items. PR entries show their live status — draft, open, closed, merged, or unavailable (colored GitHub-style icons, kept up to date while you work).
